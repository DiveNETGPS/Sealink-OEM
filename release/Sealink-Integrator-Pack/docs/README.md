# Sealink-OEM Documentation Index

Use this index to navigate modem documentation and software tooling guides.

## Modem Fundamentals

- [Getting Started](Sealink-OEM_Getting_Started.md)
- [Pinout and Interface](Sealink-OEM_Pinout_and_Interface.md)
- [Communication Protocol](Sealink-OEM_Communication_Protocol.md)
- [Basic Ranging Guide](Sealink-OEM_Basic_Ranging_Guide.md)
- [Technical Drawing (PDF)](Sealink-OEM_Technical_Drawing.pdf)
